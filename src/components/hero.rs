...
static HERO_IMAGES: &[&[Image]] = &[
    &[
			Image { name: "Transistor", logo: "/images/logos/transistor.svg" },
			Image { name: "Tuple", logo: "/images/logos/tuple.svg" },
			Image { name: "StaticKit", logo: "/images/logos/statickit.svg" }
		],
		&[
			Image { name: "Mirage", logo: "/images/logos/mirage.svg" },
			Image { name: "Laravel", logo: "/images/logos/laravel.svg" },
			Image { name: "Statamic", logo: "/images/logos/statamic.svg" }
		]
];
